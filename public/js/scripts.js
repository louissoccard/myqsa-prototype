...
function createProgressCircle(id, color) {
  ...
  var text = document.querySelector(id + ' .progressbar-text');
  ...
  bar.animate(0.009);
  var barElement = document.querySelector(id);
                ...
                return function () {
                    ...
                    var t = {
                        720: function (t, n, e) {
                            ...
                            var $, G, H, J = "linear", K = "undefined" != typeof window ? window : e.g,
                                X = "afterTween", Y = "afterTweenEnd", Z = "beforeTween", tt = "tweenCreated",
                                nt = "function", et = "string",
                                ...
                                it = function () {
                                }, ut = null, ot = null, at = V({}, r), st = function (t, n, e, r, i, u, o) {
                                    var a, s, c, f = t < u ? 0 : (t - u) / i, l = !1;
                                    ...
                                    if (!(n < e + i)) {
                                        var u = t._duration, o = t._targetState, a = e + i + u, s = n > a ? a : n,
                                            c = s >= a, f = u - (a - s), l = t._filters.length > 0;
                                    ...
                                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : J,
                                        e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r = L(n);
                                    if (at[n]) return at[n];
                                    ...
                                    return n = t, (e = [{
                                        ...
                                        key: "setConfig", value: function () {
                                            ...
                                            var i = e.promise, u = void 0 === i ? this._promiseCtor : i, o = e.start,
                                                a = void 0 === o ? it : o, s = e.finish, c = e.render,
                                                f = void 0 === c ? this._config.step || it : c, l = e.step,
                                                h = void 0 === l ? it : l;
                                            ...
                                            var p = n.from, v = n.to, _ = void 0 === v ? {} : v, y = this._currentState,
                                                d = this._originalState, m = this._targetState;
                                        ...
                                        key: "stop", value: function () {
                                            ...
                                            var e = this._currentState, r = this._originalState, i = this._targetState;
                                        ...
                                        key: "cancel", value: function () {
                                            var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                                n = this._currentState, e = this._data, r = this._isPlaying;
                            ...
                            function yt() {
                                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = new _t;
                            ...
                            var Tt = function (t) {
                                ...
                                var r = n.match(t), i = n.replace(t, kt);
                                ...
                                var n = t.match(wt).map(Math.floor), e = t.match(St)[0];
                            ...
                            function Nt(t) {
                                ...
                                [n, e, r].forEach((function (t) {
                                    return function (t, n) {
                                        for (var e in n) {
                                            var r = n[e], i = r.chunkNames, u = r.formatString,
                                                o = Dt(u, Ct(It(t, i), i));
                                            t[e] = Et(Ot, o, xt)
                                        }
                                    }(t, u)
                            ...
                            var Ut = new _t, Vt = _t.filters, Wt = function (t, n, e, r) {
                            ...
                            var Kt = new WeakMap, Xt = function () {
                                function t() {
                                    Gt(this, t), Kt.set(this, {writable: !0, value: []});
