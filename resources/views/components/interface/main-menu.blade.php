<div class="overflow-y-auto">
    ...
    <x-interface.menu-item active="{{ request()->routeIs('award.*') }}" href="{{ route('award.show') }}" icon="award">
        Award
    </x-interface.menu-item>
    @if(request()->routeIs('award.*'))
        <x-interface.main-menu-sub-menu>
            ...
            <x-interface.sub-menu-item active="{{ request()->routeIs('award.dofe') }}" href="{{ route('award.dofe') }}">
                DofE
            </x-interface.sub-menu-item>
    ...
    <x-interface.menu-item active="{{ request()->routeIs('admin-centre.*') }}" href="{{ route('admin-centre.show') }}"
                           icon="grid">
        Admin Centre
    </x-interface.menu-item>
