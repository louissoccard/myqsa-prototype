        ...
        <div class="mb-4">
            <x-interface.card title="Queen's Scout Award" href="{{ route('award.show') }}">
                <div
                    ...
                    <x-utilities.circular-progress-bar barId="icv-progress" data-percentage="25" containerClass="pr-3">
                        ICV
                        List
                    </x-utilities.circular-progress-bar>
                    <x-utilities.circular-progress-bar barId="dofe-progress" data-percentage="100"
                                                       containerClass="pl-3">
                        DofE
                    </x-utilities.circular-progress-bar>
                </div>
